    ...
    <aside className="bg-gradient-to-b from-pink-500 via-rose-500 to-pink-600 text-white w-64 min-h-screen p-6 flex flex-col shadow-xl">
      ...
      <div className="mb-10">
        <div className="flex items-center gap-3 mb-2">
          ...
          <div>
            <h2 className="text-2xl font-serif font-bold tracking-wide select-none">AnimaLand</h2>
      ...
      <div className="mt-auto pt-6 border-t border-white/20">
        <div className="bg-white/10 backdrop-blur-sm rounded-xl p-4">
          ...
          <button className="text-sm text-white hover:text-white/80 transition-colors font-medium">
            Contact Support →
          </button>
        </div>
      </div>
